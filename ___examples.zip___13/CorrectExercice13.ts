...
type CountryWithCurrency = [string, string, string]; // Assuming the order is [countryName, currencyName, currencyCode]
...
// The following line will result in a type error:
